...
function populateCalendar(events, dateString) {
    for (let i = 0; i < events.length; i++) {
        ...
        // Adds each event row
        document.getElementById("calendar-table").insertAdjacentHTML("beforeend", '<tr><td style="width: 15%; text-align: center; padding: 5px;">'+parseDate(date)+'</td><td>'+events[i].summary+'</td></tr>');
