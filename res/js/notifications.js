        ...
        if (result.notifications.length > 0) {
            for (i=0; i<result.notifications.length; i++) {
                ...
                if (date.toDateString() == resultDate.toDateString()) {
                    ...
                    if (resultDate.getHours() > 12) {
                        altDate = 'Time received by this computer: '+(resultDate.getHours()-12) + ":" + ('0' + resultDate.getMinutes()).slice(-2) + " PM";
                    }
                    else {
                        altDate = 'Time received by this computer: '+resultDate.getHours() + ":" + ('0' + resultDate.getMinutes()).slice(-2) + " AM";
                    }
                }
